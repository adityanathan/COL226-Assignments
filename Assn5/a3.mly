...
function_def_expr:
	BACKSLASH ID DOT exp_parser													{FunctionAbstraction($2,$3)}
	| function_call_expr																{ $1 }

function_call_expr:
	function_def_expr PAREN function_call_expr PAREN				{FunctionCall{$1,$3}}
	| let_expr																			{$1}
...
def_parser:
	def_unit SEMICOLON def_parser											{Sequence($1::$2)}
	|	def_unit PARALLEL def_parser										{Parallel($1::$2)}
	|	LOCAL def_parser IN def_parser									{Local($2,$4)}
	|	def_unit																				{$1}
;
