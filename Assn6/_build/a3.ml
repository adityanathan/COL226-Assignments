...
# 738 "a3.ml"
               : 'function_def_expr))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 3 : A5_secd.definition) in
    let _4 = (Parsing.peek_val __caml_parser_env 1 : A5_secd.expr) in
    Obj.repr(
# 117 "a3.mly"
                                             (Let(_2,_4))
# 746 "a3.ml"
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : A5_secd.definition) in
    Obj.repr(
# 133 "a3.mly"
                                         (Sequence([_1]@[_3]))
# 796 "a3.ml"
...
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 3 : A5_secd.definition) in
    let _4 = (Parsing.peek_val __caml_parser_env 1 : A5_secd.definition) in
    Obj.repr(
# 135 "a3.mly"
                                            (Local(_2,_4))
# 812 "a3.ml"
...
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 4 : string) in
    let _4 = (Parsing.peek_val __caml_parser_env 2 : 'type_expr) in
    let _6 = (Parsing.peek_val __caml_parser_env 0 : A5_secd.expr) in
    Obj.repr(
# 140 "a3.mly"
                                                  ( Simple(_2, _6, _4) )
# 828 "a3.ml"
...
let def_parser (lexfun : Lexing.lexbuf -> token) (lexbuf : Lexing.lexbuf) =
   (Parsing.yyparse yytables 1 lexfun lexbuf : A5_secd.definition)
let exp_parser (lexfun : Lexing.lexbuf -> token) (lexbuf : Lexing.lexbuf) =
   (Parsing.yyparse yytables 2 lexfun lexbuf : A5_secd.expr)
