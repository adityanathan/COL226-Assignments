...
(* For simplicity the stack will be implemented as a list of bigint values, and the program is a list of opcodes. The stack machine is to be defined as a tail-recursive function *)
